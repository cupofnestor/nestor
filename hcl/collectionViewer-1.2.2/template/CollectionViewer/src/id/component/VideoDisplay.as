package id.component
{
	...
	import id.element.VideoThumbLoader
	...
	/**
	 * <p>The VideoDisplay component is the main component for the VideoViewer module.  It contains all the neccessary display objects for the module.</p>
	 *
	 * <p>
	 ...
	 *
	 * 		videoDisplay.id = Number;
	 *
	 * addChild(videoDisplay);</listing>
	 *
	 * @see id.core.VideoViewer
	 * 
	 * @includeExample VideoDisplay.as
	 * 
	 * @langversion 3.0
	 * @playerversion AIR 2
	 ...
	 */
	public class VideoDisplay extends TouchComponent
	{
		private var media:VideoLoader;
		private var metadata:TouchComponent;
		private var thumbnail:VideoThumbLoader;
		 ...
		 * The Constructor.
		 * <pre>
		 * <strong>var videoDisplay:VideoDisplay = new VideoDisplay();
		 * addChild(videoDisplay);</strong></pre>
		 *
		 */
		 ...
		 * <pre>
		 * <strong>videoDisplay.Dispose();</strong></pre>
		 *
		 */
		...
		{
			// Style
			globalScale=VideoParser.settings.GlobalSettings.globalScale;
			scale=VideoParser.settings.GlobalSettings.scale;
			imagesNormalize=VideoParser.settings.GlobalSettings.imagesNormalize;
			infoPaddingNumber=VideoParser.settings.GlobalSettings.infoPadding;
			maxScale=VideoParser.settings.GlobalSettings.maxScale;
			minScale=VideoParser.settings.GlobalSettings.minScale;
			...
			infoBtnStyle=VideoParser.settings.ControlBtns;
			backgroundOutlineStyle=VideoParser.settings.BackgroundOutline;
			backgroundGraphicStyle=VideoParser.settings.BackgroundGraphic;
			titleStyle=VideoParser.settings.InfoText.TitleText;
			descriptionStyle=VideoParser.settings.InfoText.DescriptionText;
			authorStyle=VideoParser.settings.InfoText.AuthorText;
			publishStyle=VideoParser.settings.InfoText.PublishText;

			// Gestures
			if (VideoParser.settings.Gestures!=undefined)
			{
				dragGesture=VideoParser.settings.Gestures.drag== "true" ? true : false;
				rotateGesture=VideoParser.settings.Gestures.rotate== "true" ? true : false;
				scaleGesture=VideoParser.settings.Gestures.scale== "true" ? true : false;
				doubleTapGesture=VideoParser.settings.Gestures.doubleTap== "true" ? true : false;
				flickGesture=VideoParser.settings.Gestures.flick== "true" ? true : false;
			}

			// Data
			mediaUrl=VideoParser.settings.Content.Source[id].url;
			thumbUrl=VideoParser.settings.Content.Source[id].url;
			qrCodeTag=VideoParser.settings.Content.Source[id].qrCodeTag;
			titleText=VideoParser.settings.Content.Source[id].title;
			descriptionText=VideoParser.settings.Content.Source[id].description;
			authorText=VideoParser.settings.Content.Source[id].author;
			publishText=VideoParser.settings.Content.Source[id].publish;
			...
			thumbnail = new VideoThumbLoader();
